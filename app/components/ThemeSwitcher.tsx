...
export function ThemeSwitcher() {
  ...
  if (!mounted) {
    return <button className="w-8 h-8 flex items-center justify-center border-2 border-transparent"></button>;
  }

  return (
    <button
      onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
      className="flex items-center justify-center p-2 border-2 border-ink bg-canvas text-ink hover:bg-ink hover:text-canvas transition-colors duration-200"
